...
void Time::Calculate_passedbytime(int train, int bunch){
	...
	else if (number_of_train == 1 && number_of_bunch > 1) passedbytime = passedbytimes[std::pair< int, int >(number_of_train, number_of_bunch)] + bunch_spacing;
	else if (number_of_train > 1 && number_of_bunch == 1) passedbytime = passedbytimes[std::pair< int, int >(number_of_train, number_of_bunch)] + train_spacing;
	else if (number_of_train > 1 && number_of_bunch > 1) passedbytime = passedbytimes[std::pair< int, int >(number_of_train, number_of_bunch)] + bunch_spacing + train_spacing;

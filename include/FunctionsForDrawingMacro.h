...
void SetupHistoTitles(std::string subdetector_name, std::string layer, std::string & histo_name1D,
	...
	histo_title2D = "HitMap for " + subdetector_name + layercount.str();
	...
	energyhisto_title3D = "HitMap with the hit energy for " + subdetector_name + layercount.str() + ";z [mm];x[mm];y[mm]";
	...
	particleoriginshisto_title = "Origins of std::pair background particles for " + subdetector_name + layercount.str();

	histo_name_time = "HitsTime_" + subdetector_name + "_Layer_" + layer;
	histo_title_time = "Hit time for " + subdetector_name + layercount.str();
